...
SELECT DISTINCT __NODE1__ AS "node", CONCAT(__NODE1_TYPE__, '|') AS "NODE_TYPE"
FROM __TABLE__
UNION
SELECT DISTINCT __NODE2__ AS "node" ,  CONCAT(__NODE2_TYPE__, '|') AS "NODE_TYPE"
FROM __TABLE__
"""
)
...
"""
CREATE OR REPLACE __RESULT_TABLE__ AS 
SELECT DISTINCT __NODE1__ AS "Source" , CONCAT(__NODE2__, '|') AS "Destination"
FROM __TABLE__
"""
)
